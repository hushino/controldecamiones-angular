...
import com.control.camiones.config.audit.AuditEventConverter;
import com.control.camiones.domain.PersistentAuditEvent;
...
import static com.control.camiones.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
