...
import { ContribuyenteComponent } from 'app/entities/contribuyente/contribuyente.component';
...
describe('Component Tests', () => {
  describe('Contribuyente Management Component', () => {
    let comp: ContribuyenteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContribuyenteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contribuyentes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
