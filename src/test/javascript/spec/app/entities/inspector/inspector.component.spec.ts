...
import { InspectorComponent } from 'app/entities/inspector/inspector.component';
...
describe('Component Tests', () => {
  describe('Inspector Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.inspectors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
